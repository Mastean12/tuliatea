export const homeContent = {
  ...
  cta: {
    title: "Ready to Elevate Your Tea Experience?",
    subtitle:
      "Explore our collection of premium Kenyan teas and discover your new favorite blend.",
    ctaPrimary: "Shop Now",
...
export const aboutContent = {
  ...
  cta: {
    ...
    subtitle: "Try our premium Kenyan teas and taste the passion in every sip.",
    ctaPrimary: "Shop Our Collection",
  },
} as const
